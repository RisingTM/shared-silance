...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "My moony" },
      { name: "description", content: "Cupcake" },
      { name: "author", content: "Our Journey" },
      { property: "og:title", content: "My moony" },
      { property: "og:description", content: "Cupcake" },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "My moony" },
      { name: "twitter:description", content: "Cupcake" },
      ...
      { name: "theme-color", content: "#f5ecd9" },
